...
def real_time_monitor():
    ...
    while True:
        ...
        for file_path in new_files:
            ...
            #     out_pdf = Path(file_path).with_suffix(".pdf")
            #     pdfkit.from_file(file_path, out_pdf, configuration=cfg,
...
if True:
    logging.basicConfig(filename='/home/dune/Documents/FEMB_QC/Data/QC.log',
                        level=logging.INFO,
