...
# =======================================
    ...
    def CALI_report_6(self):
        ...
        qc.GetGain(self.fembs, self.fembsID, Cali06_dict, self.savedir, "CALI6/", "CALI6_SE_{}_{}_{}_vdac{:06d}mV", "200mVBL", "14_0mVfC", "2_0us", dac_list, 500, 50)
        #   Get RMS
        ...
        for afile in QC_t15_dict.keys():
            ...
            for ifemb in self.fembs:
                ...
                if 'DC_Noise' in fname:
                    ...
                    elif((np.max(ped)>8500) or (np.max(ped)<7900)):
                        log.check_log1501[femb_id]['Result'] = False
                    else:
                ...
                if "SHA_SE" in fname:
                    ...
                    print(log.check_log15csv[femb_id]['SHA_SE_ped'])
                    if np.max(rms) > 4:
