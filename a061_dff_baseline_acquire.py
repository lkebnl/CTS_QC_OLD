...
chk.wib_mon_switches(dac0_sel=0, dac1_sel=0, dac2_sel=0, dac3_sel=0, mon_vs_pulse_sel=0, inj_cal_pulse=1)
...
fname = "Raw_DIFF_{}_{}_{}_0x{:02x}".format("200mVBL", "14_0mVfC", "2_0us", 0x00)
snc = 1  # 200 mV
sg0 = 0
sg1 = 0  # 14mV/fC
st0 = 1
...
for femb_id in fembs:
    ...
    # sts： enables the 200 fF test capacitor individually for each channel
    chk.set_fe_board(sts=0, snc=snc, sg0=sg0, sg1=sg1, st0=st0, st1=st1, sdd=1, swdac=0, dac=0x00)
    adac_pls_en = 0
